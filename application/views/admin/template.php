    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="<?= base_url('admin'); ?>" aria-expanded="false">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?= base_url('admin/film'); ?>">Film</a></li>
                            <li><a href="<?= base_url('admin/user'); ?>">User</a></li>

                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="<?= base_url('admin/transaksi_masuk'); ?>" aria-expanded="false">
                            <i class="fa fa-dollar"></i><span class="nav-text">Transaksi Masuk</span>
                        </a>
                    </li>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by Krishna Hendra</p>
            </div>
        </div>
        <!--**********************************
            Footer end
